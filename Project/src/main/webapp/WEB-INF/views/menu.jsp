    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid" >
            <div class="navbar-header">
                <a class="navbar-brand" href="index.html">CityBank</a>
            </div>
            <ul class="nav navbar-nav">
                <li class="active"><a href="/cityBankAccounts/<%=userId %>">Account Details</a></li>
                <li><a href="/CustomerAggregateBalance/<%=userId %>">Aggregate Account Details</a></li>
                <li><a href="/cityBankCustomers">All Account Details</a></li>
            </ul>
