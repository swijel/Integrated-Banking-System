...
@XmlRootElement
@Entity
public class Infinity_bank_customer_master {
	...
	public Infinity_bank_customer_master() {
		// TODO Auto-generated constructor stub
	}

	public Infinity_bank_customer_master(int custId, String custName, String custPanNumber, String custAadhaarNumber,
			String custEkycNumber) {
		super();
		this.custId = custId;
